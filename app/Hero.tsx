...
export function Hero(){
  ...
  <>
    <div className="relative h-[95vh]  ">
      ...
      />
      <div className="w-5xl h-full flex items-center relative justify-end ">
        <div className="bg-[#141959]/[.85] relative w-[100%] max-w-xl rounded-2xl flex flex-col justify-center px-10 py-14  mx-4 text-white ">
          <h1 className={`text-3xl md:text-4xl pb-6 `} >Welcome To Juan Rios' <i className="bg-[#0cfeff]/[.60] px-2">Digital Portfolio</i></h1>
