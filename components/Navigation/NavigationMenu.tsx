...
export const navigation = [
  ...
  { name: 'Website Projects', href: '/web-development', current: false, icon: <MdDeveloperMode/>, },
  { name: 'Graphic Design Projects', href: '/graphic-design', current: false, icon: <BiAtom/> },
];
